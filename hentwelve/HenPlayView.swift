...
struct HenPlayView: UIViewRepresentable {

    let startPoint: URL
    let launch: HenLaunchStore
    let session: HenSessionState
    let orientation: HenOrientationManager
    let onReady: () -> Void
...
final class Handler: NSObject, WKNavigationDelegate, WKUIDelegate {
    ...
    private let launch: HenLaunchStore
    private let session: HenSessionState
    private let orientation: HenOrientationManager
    ...
    init(
        startPoint: URL,
        launch: HenLaunchStore,
        session: HenSessionState,
        orientation: HenOrientationManager,
